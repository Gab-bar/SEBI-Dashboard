  ...
  const renderDepartmentRow = (dept: Department, level: number = 0) => {
    ...
    return (
      <React.Fragment key={dept.id}>
        <tr className="hover:bg-surface-bg transition-colors border-b border-gray-100">
          <td className="px-4 lg:px-6 py-4">
            <div className="flex items-center gap-2" style={{ paddingLeft: `${level * 24}px` }}>
              ...
              <div>
                <div className="text-sm font-medium text-txt-primary">{dept.name}</div>
                <div className="text-xs text-txt-muted">Cost Center: {dept.costCenter}</div>
              </div>
            </div>
          </td>
          <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-txt-primary">{dept.head}</span>
            </div>
          </td>
          <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            <span className="px-2.5 py-1 bg-gray-100 text-txt-primary rounded text-xs font-medium">
              {dept.users} users
            </span>
          </td>
          <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            <span className="text-sm text-txt-primary">{dept.roles} roles assigned</span>
          </td>
          <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            <span className="text-sm text-txt-primary">{dept.location}</span>
          </td>
          <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            <span className="px-2.5 py-1 bg-success-soft text-success rounded-full text-xs font-medium">
              {dept.status}
            </span>
          </td>
  ...
  const renderHierarchyItem = (dept: Department, level: number = 0) => {
    ...
    return (
      <div key={dept.id} className="mb-3">
        <div className="bg-white border border-primary/[0.06] rounded-lg p-4 hover:shadow-sm transition-shadow">
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-base font-semibold text-txt-primary">{dept.name}</h3>
        ...
        {hasChildren && isExpanded && dept.children && (
          <div className="ml-8 mt-2 border-l-2 border-primary/[0.06] pl-4">
    ...
    <div className="min-h-screen bg-surface-bg">
      ...
      <div className="bg-white border-b border-primary/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
            <div>
              <h1 className="text-2xl font-bold text-txt-primary">Department Mapping</h1>
              <p className="text-sm text-txt-muted mt-1">Organizational structure and user-department relationships</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="glass-panel p-6 shadow-sm">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-txt-primary">Department Hierarchy</h2>
            <p className="text-sm text-txt-muted mt-1">Organizational structure and reporting relationships</p>
          </div>
