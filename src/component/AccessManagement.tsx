...
function AccessManagement() {
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div>
                <h1 className="section-header-title mb-2">Access Management</h1>
                <p className="text-txt-secondary">Control and monitor system user access for the portal</p>
            </div>
                  ...
                  >
                      <div className="flex flex-col items-start gap-4">
                          <div className="text-txt-secondary flex justify-between w-full">
                              <span><p className="text-sm font-medium text-txt-secondary mb-1">{stat.label}</p></span>
                              <span>{stat.icon}</span>
                          </div>
                          <div>
