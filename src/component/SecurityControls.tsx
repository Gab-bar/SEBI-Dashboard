...
export default function SecurityControls() {
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Security Controls Management</h1>
                <p className="text-gray-600">Track technical security control implementation and compliance</p>
            </div>
