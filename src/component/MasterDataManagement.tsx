  ...
  return (
    <div className="min-h-screen bg-surface-bg p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          <h1 className="text-2xl md:section-header-title">Master Data Management</h1>
          <p className="text-sm text-txt-secondary mt-1">Manage system configuration and reference data</p>
        </div>
      ...
      <div className="glass-panel mb-6">
                  ...
                  <tr key={item.id} className="hover:bg-surface-bg transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-txt-primary">{item.category}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium text-txt-primary">{item.name}</div>
                      <div className="text-sm text-txt-muted">{item.description}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-txt-primary font-mono">{item.code}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-txt-primary">{item.records}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-txt-primary">{item.lastUpdated}</div>
                    </td>
        ...
        <div className="lg:hidden divide-y divide-primary/[0.06]">
          {filteredData.length === 0 ? (
            ...
            filteredData.map((item) => (
              <div key={item.id} className="p-4 hover:bg-surface-bg">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <div className="text-sm font-medium text-txt-primary">{item.name}</div>
                    <div className="text-xs text-txt-muted mt-1">{item.description}</div>
                  </div>
                ...
                <div className="space-y-2 mb-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-txt-primary">{item.category}</span>
                  </div>
                  <div className="text-sm">
                    <span className="text-txt-muted">Code: </span>
                    <span className="text-txt-primary font-mono">{item.code}</span>
                  </div>
                  <div className="text-sm">
                    <span className="text-txt-muted">Records: </span>
                    <span className="text-txt-primary">{item.records}</span>
                  </div>
                  <div className="text-sm">
                    <span className="text-txt-muted">Updated: </span>
                    <span className="text-txt-primary">{item.lastUpdated}</span>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-6">
          <div className="text-sm text-txt-secondary mb-2">Data Quality Score</div>
          <div className="section-header-title mb-3">{stats.dataQualityScore}%</div>
          <div className="progress-track overflow-hidden mb-2" role="progressbar" aria-valuemin={0} aria-valuemax={100}>
            <div className="h-full bg-primary" style={{ width: `${stats.dataQualityScore}%` }}></div>
          </div>
          <div className="text-sm text-txt-secondary">Excellent data consistency</div>
        </div>

        {/* Active Categories Card */}
        <div className="glass-panel p-6">
          <div className="text-sm text-txt-secondary mb-2">Active Categories</div>
          <div className="section-header-title mb-3">{stats.activeCategories}</div>
          <div className="text-sm text-txt-secondary mb-2">{stats.totalRecords} total records</div>
        ...
        {/* Recent Updates Card */}
        <div className="glass-panel p-6">
          <div className="text-sm text-txt-secondary mb-2">Recent Updates</div>
          <div className="section-header-title mb-3">{stats.recentUpdates}</div>
          <div className="text-sm text-txt-secondary mb-2">This month</div>
          <div className="progress-track overflow-hidden" role="progressbar" aria-valuemin={0} aria-valuemax={100}>
            <div className="h-full bg-primary" style={{ width: '100%' }}></div>
          </div>
        </div>
