    ...
    <div className="min-h-screen bg-surface-bg p-8">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-semibold text-txt-primary">CERT-In Integration & Threat Intelligence</h1>
              ...
              <div className="px-6 py-4 border-b border-primary/[0.06] bg-surface-bg">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium border ${getSeverityClass(report.severity)}`}>
                      {report.severity}
                    </span>
                  </div>
              ...
              <div className="px-6 py-5">
                <div className="grid grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4">
                    {/* Threat Details */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Threat Details</h3>
                      <div className="space-y-1 text-sm">
                        <div className="text-txt-primary">Type: {report.threatDetails.type}</div>
                        <div className="text-txt-primary">Category: {report.threatDetails.category}</div>
                      </div>
                    </div>

                    {/* Attack Vectors */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Attack Vectors</h3>
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Industries of Compromise</h3>
                    ...
                    {/* Targets */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Targets</h3>
                      <ul className="space-y-1">
                        {report.targets.map((target, idx) => (
                          <li key={idx} className="text-sm text-txt-primary">{target}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    {/* Email */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Email</h3>
                  ...
                  <div className="space-y-4">
                    {/* Submission */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Submission</h3>
                      <div className="space-y-1 text-sm">
                        <div className="text-txt-primary">Date: {report.submission.date}</div>
                        <div className="text-txt-primary">Time: {report.submission.time}</div>
                        <div className="text-txt-primary">Method: {report.submission.method}</div>
                      </div>
                    </div>

                    {/* Mitigation Measures */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Mitigation Measures</h3>
                  ...
                  <div className="space-y-4">
                    {/* Collaboration */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Collaboration</h3>
                      <div className="space-y-1 text-sm">
                        <div className="text-txt-primary">IOC: {report.collaboration.ioc}</div>
                        <div className="text-txt-primary">Sharing: {report.collaboration.sharing}</div>
                      </div>
                    </div>

                    {/* Follow-up Actions */}
                    <div>
                      <h3 className="text-sm font-semibold text-txt-primary mb-2">Follow-up Actions</h3>
                      <ul className="space-y-1.5">
                        {report.followUpActions.map((action, idx) => (
                          <li key={idx} className="flex items-start gap-2 text-sm text-txt-primary">
                            <span className="w-1.5 h-1.5 rounded-full bg-primary-soft0 mt-2 flex-shrink-0"></span>
                            <span>{action}</span>
                          </li>
                        ))}
                      </ul>
